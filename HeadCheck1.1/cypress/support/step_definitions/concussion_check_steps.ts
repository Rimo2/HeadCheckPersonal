...
const SKIP_BUTTON_INTRO ='.headcheck-skip-button';
...
// // Check if the SKIP_BUTTON_INTRO exists
//     cy.get(SKIP_BUTTON_INTRO).then(($button) => {
//         // If the button exists, click on it
//         if ($button.length > 0) {
//             cy.get(SKIP_BUTTON_INTRO).click();
//         } else {
//             // If the button does not exist, log a message or continue with execution
//             cy.log("Skip button not found. Continuing with execution...");
//             // Or you can simply continue the test without logging any message
//             // Continue with your test steps here
//         }
//     });
